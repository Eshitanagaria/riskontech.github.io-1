const applicantsData = {
  ...
  "205743": {
    ...
    "history": [
      {"Month_Offset": -4, "Predicted_Prob_Default": 0.150371, "Payment_Status": "On Time"},
      {"Month_Offset": -3, "Predicted_Prob_Default": 0.150371, "Payment_Status": "5 days late"},
      {"Month_Offset": -2, "Predicted_Prob_Default": 0.300319, "Payment_Status": "12 days late"},
      {"Month_Offset": -1, "Predicted_Prob_Default": 0.329599, "Payment_Status": "22 days late"},
  ...
  "229335": {
    ...
    "geminiSummary": "Amit Kumar is assessed as a 'Low' risk candidate. His animated risk profile, while showing minor fluctuations, remains consistently within the low-probability-of-default range. His payment history is exemplary, with all installments paid on time or slightly early. This demonstrates a reliable and responsible financial character, making him a strong candidate for lending.",
     "history": [
      {"Month_Offset": -4, "Predicted_Prob_Default": 0.534676, "Payment_Status": "3 days early"},
      {"Month_Offset": -3, "Predicted_Prob_Default": 0.534676, "Payment_Status": "On Time"},
      {"Month_Offset": -2, "Predicted_Prob_Default": 0.447845, "Payment_Status": "On Time"},
      {"Month_Offset": -1, "Predicted_Prob_Default": 0.467993, "Payment_Status": "On Time"},
  ...
  "257537": {
    ...
    "history": [
        {"Month_Offset": -4, "Predicted_Prob_Default": 0.623944, "Payment_Status": "On Time"},
  ...
  "338391": {
    ...
    "geminiSummary": "Pooja Sharma is a 'Low' risk applicant. The model's tracking visualization shows that while there was a slight elevation in risk in the past, her profile has since stabilized to a very low probability of default. Her payment history is clean, with all recent payments made on time. This positive trend indicates a responsible borrower who has successfully managed their financial obligations. She is recommended for approval.",
     "history": [
        {"Month_Offset": -4, "Predicted_Prob_Default": 0.767249, "Payment_Status": "On Time"},
  ...
  "348704": {
    ...
    "history": [
      {"Month_Offset": -4, "Predicted_Prob_Default": 0.75768, "Payment_Status": "On Time"},
      {"Month_Offset": -3, "Predicted_Prob_Default": 0.735494, "Payment_Status": "12 days late"},
      {"Month_Offset": -2, "Predicted_Prob_Default": 0.910753, "Payment_Status": "21 days late"},
      {"Month_Offset": -1, "Predicted_Prob_Default": 0.901038, "Payment_Status": "28 days late"},
      {"Month_Offset": 0, "Predicted_Prob_Default": 0.68, "Payment_Status": "30+ days late"}
    ]
  },
  "419683": {
    ...
    "history": [
      {"Month_Offset": -4, "Predicted_Prob_Default": 0.318301, "Payment_Status": "5 days early"},
      {"Month_Offset": -3, "Predicted_Prob_Default": 0.296913, "Payment_Status": "8 days late"},
      {"Month_Offset": -2, "Predicted_Prob_Default": 0.440912, "Payment_Status": "On Time"},
      {"Month_Offset": -1, "Predicted_Prob_Default": 0.670534, "Payment_Status": "On Time"},
  ...
  "440013": {
    ...
    "history": [
      {"Month_Offset": -4, "Predicted_Prob_Default": 0.724744, "Payment_Status": "On Time"},
      {"Month_Offset": -3, "Predicted_Prob_Default": 0.771549, "Payment_Status": "On Time"},
      {"Month_Offset": -2, "Predicted_Prob_Default": 0.724744, "Payment_Status": "On Time"},
      {"Month_Offset": -1, "Predicted_Prob_Default": 0.724744, "Payment_Status": "On Time"},
      {"Month_Offset": 0, "Predicted_Prob_Default": 0.31, "Payment_Status": "On Time"}
    ]
  }
};
