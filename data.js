const applicantsData = {
  "120397": {
    ...
    "history": [
      {"Month_Offset":-6, "Predicted_Prob_Default": 0.896372, "Payment_Status": "On Time"},
      {"Month_Offset":-5, "Predicted_Prob_Default": 0.222188, "Payment_Status": "On Time"},
      {"Month_Offset":-4, "Predicted_Prob_Default": 0.171631, "Payment_Status": "5 days early"},
      {"Month_Offset":-3, "Predicted_Prob_Default": 0.200892, "Payment_Status": "On Time"},
      {"Month_Offset":-2, "Predicted_Prob_Default": 0.199905, "Payment_Status": "On Time"},
      {"Month_Offset":-1, "Predicted_Prob_Default": 0.220888, "Payment_Status": "On Time"},
      {"Month_Offset":0, "Predicted_Prob_Default": 0.18, "Payment_Status": "On Time"}
    ]
  },
  "205743": {
    ...
    "history": [
      {"Month_Offset":-4, "Predicted_Prob_Default": 0.057127, "Payment_Status": "On Time"},
      {"Month_Offset":-3, "Predicted_Prob_Default": 0.341878, "Payment_Status": "5 days late"},
      {"Month_Offset":-2, "Predicted_Prob_Default": 0.518711, "Payment_Status": "12 days late"},
      {"Month_Offset":-1, "Predicted_Prob_Default": 0.817281, "Payment_Status": "22 days late"},
      {"Month_Offset":0, "Predicted_Prob_Default": 0.85, "Payment_Status": "28 days late"}
    ]
  },
  "229335": {
    ...
    "geminiSummary": "Amit Kumar is assessed as a 'Low' risk candidate. His animated risk profile, while showing minor fluctuations, remains consistently within the low-probability-of-default range. His payment history is exemplary, with all installments paid on time or slightly early. This demonstrates a reliable and responsible financial character, making him a strong candidate for lending.",
     "history": [
      {"Month_Offset":-4, "Predicted_Prob_Default": 0.091136, "Payment_Status": "3 days early"},
      {"Month_Offset":-3, "Predicted_Prob_Default": 0.123594, "Payment_Status": "On Time"},
      {"Month_Offset":-2, "Predicted_Prob_Default": 0.119939, "Payment_Status": "On Time"},
      {"Month_Offset":-1, "Predicted_Prob_Default": 0.082191, "Payment_Status": "On Time"},
      {"Month_Offset":0, "Predicted_Prob_Default": 0.08, "Payment_Status": "On Time"}
    ]
  },
  "234968": {
    ...
    "history": [
      {"Month_Offset":-4, "Predicted_Prob_Default": 0.063259, "Payment_Status": "On Time"},
      {"Month_Offset":-3, "Predicted_Prob_Default": 0.40111, "Payment_Status": "8 days late"},
      {"Month_Offset":-2, "Predicted_Prob_Default": 0.72895, "Payment_Status": "18 days late"},
      {"Month_Offset":-1, "Predicted_Prob_Default": 0.94121, "Payment_Status": "25 days late"},
      {"Month_Offset":0, "Predicted_Prob_Default": 0.95, "Payment_Status": "30+ days late"}
    ]
  },
  "257537": {
    ...
    "history": [
        {"Month_Offset":-4, "Predicted_Prob_Default": 0.301379, "Payment_Status": "On Time"},
        {"Month_Offset":-3, "Predicted_Prob_Default": 0.627811, "Payment_Status": "10 days late"},
        {"Month_Offset":-2, "Predicted_Prob_Default": 0.581374, "Payment_Status": "8 days late"},
        {"Month_Offset":-1, "Predicted_Prob_Default": 0.492191, "Payment_Status": "On Time"},
  ...
  "338391": {
    ...
    "geminiSummary": "Pooja Sharma is a 'Low' risk applicant. The model's tracking visualization shows that while there was a slight elevation in risk in the past, her profile has since stabilized to a very low probability of default. Her payment history is clean, with all recent payments made on time. This positive trend indicates a responsible borrower who has successfully managed their financial obligations. She is recommended for approval.",
     "history": [
        {"Month_Offset":-4, "Predicted_Prob_Default": 0.251479, "Payment_Status": "On Time"},
        {"Month_Offset":-3, "Predicted_Prob_Default": 0.218374, "Payment_Status": "On Time"},
        {"Month_Offset":-2, "Predicted_Prob_Default": 0.128939, "Payment_Status": "2 days early"},
        {"Month_Offset":-1, "Predicted_Prob_Default": 0.102191, "Payment_Status": "On Time"},
        {"Month_Offset":0, "Predicted_Prob_Default": 0.10, "Payment_Status": "On Time"}
    ]
  },
  "348704": {
    ...
    "history": [
      {"Month_Offset":-4, "Predicted_Prob_Default": 0.231279, "Payment_Status": "On Time"},
      {"Month_Offset":-3, "Predicted_Prob_Default": 0.612374, "Payment_Status": "12 days late"},
      {"Month_Offset":-2, "Predicted_Prob_Default": 0.882939, "Payment_Status": "21 days late"},
      {"Month_Offset":-1, "Predicted_Prob_Default": 0.923191, "Payment_Status": "28 days late"},
      {"Month_Offset":0, "Predicted_Prob_Default": 0.90, "Payment_Status": "30+ days late"}
    ]
  },
  "419683": {
    ...
    "history": [
      {"Month_Offset":-4, "Predicted_Prob_Default": 0.352199, "Payment_Status": "5 days early"},
      {"Month_Offset":-3, "Predicted_Prob_Default": 0.528374, "Payment_Status": "8 days late"},
      {"Month_Offset":-2, "Predicted_Prob_Default": 0.482939, "Payment_Status": "On Time"},
      {"Month_Offset":-1, "Predicted_Prob_Default": 0.462191, "Payment_Status": "On Time"},
      {"Month_Offset":0, "Predicted_Prob_Default": 0.45, "Payment_Status": "2 days late"}
    ]
  },
  "440013": {
    ...
    "history": [
      {"Month_Offset":-4, "Predicted_Prob_Default": 0.123179, "Payment_Status": "On Time"},
      {"Month_Offset":-3, "Predicted_Prob_Default": 0.121374, "Payment_Status": "On Time"},
      {"Month_Offset":-2, "Predicted_Prob_Default": 0.112939, "Payment_Status": "On Time"},
      {"Month_Offset":-1, "Predicted_Prob_Default": 0.112191, "Payment_Status": "On Time"},
      {"Month_Offset":0, "Predicted_Prob_Default": 0.12, "Payment_Status": "On Time"}
    ]
  }
};
